 ...
 */
@IocBean
public class GenericDao<T> extends IdEntityService<T> {
	...
	public List<T> search(Class<T> c) {
		Condition condition = Cnd.where("1", "=", "1");
		return dao.query(c, condition, null);
	...
	// return dao.update(c, chain, condition);
	// }
	 ...
	 * @return int
	 */
	public int searchCount(Class<T> c) {
		return dao.count(c);
	}
	 ...
	 * @return T
	 */
	public T updateWidth(T t, String fieldName) {
	 ...
	 *            关联的对象
	 */
	public void deleteWidth(T t, String fieldName) {
	...
	// * @return true 成功,false 失败
	// */
	// public boolean updateRelation(String fieldName, Chain chain, Condition
	// condition) {
