...
<link rel="stylesheet" href="/patric/css/main.css" />
<link rel="stylesheet" href="/patric/css/patric.css" />
<!-- PATRIC CSS & JS -->
...
<script src="/patric/js/libs/modernizr-1.6.min.js"></script>
<script src="/patric/js/plugins.min.js"></script>
<script src="/patric/js/script.js"></script>
...
<body class="normal home">
	...
	<div class="main-header no-underline-links">
		<div class="masthead">
			<div class="wrapper">
				<a class="logo" href="/portal/portal/patric/Home">PATRIC Home</a>
				<ul class="main-nav no-decoration">
					<li class="first active"><a class="home active"
						href="/portal/portal/patric/Home">Home</a>
						<div class="submenu">
							<ul>
								<li><a href="/portal/portal/patric/Home">PATRIC Home</a></li>
								<li><a href="/portal/portal/patric/TB">TB @ PATRIC</a></li>
							</ul>
						</div></li>
					<li class="has-sub"><a href="#">Organisms</a>
						<div class="submenu two-col">
							...
							<ul>
								<li><a
									href="/portal/portal/patric/Taxon?cType=taxon&amp;cId=2">All
										Bacteria</a></li>
							</ul>
						</div></li>
	...
	<!--[if lt IE 9]>
			<div class="msg-box-below-topnav">
				<span>It appears you are using Microsoft Internet Explorer Version 8 or lower, which is incompatible with most of PATRIC"s functionality. We recommend using Chrome, Firefox, Safari, or Internet Explorer 9 (or higher) for better performance.</span>
			</div>
		<![endif]-->
	<!--[if gte IE 9]>
			<script type="text/javascript">
	...
	<footer
		...
		<div class="container">
			<div class="column" style="border: 0px">
				<div class="wrapper">
					<h4 class="close2x normal-weight">PATRIC</h4>
			...
			<div class="column">
				<div class="wrapper">
					<h4 class="normal-weight close2x">How to Cite PATRIC</h4>
					<p>If you use PATRIC web resources to assist in research
			...
			<div class="column last bold">
				<div class="wrapper">
					...
					<ul class="left no-decoration">
						<li><a class="footer-icons sprite-icon-subscribe"
							href="//enews.patricbrc.org/subscribe/">Subscribe</a></li>
						<li><a class="footer-icons sprite-icon-twitter"
							href="//twitter.com/PATRICBRC">Twitter</a></li>
						<li><a class="footer-icons sprite-icon-facebook"
							href="//www.facebook.com/pages/Pathosystems-Resource-Integration-Center-PATRIC/117100971687823">Facebook</a></li>
					</ul>
					<ul class="left no-decoration">
						<li><a class="footer-icons sprite-icon-enews"
							href="//enews.patricbrc.org/">eNews</a></li>
						<li><a class="footer-icons sprite-icon-rss"
							href="//enews.patricbrc.org/feed/">RSS</a></li>
						<li><a class="footer-icons sprite-icon-youtube"
							href="//www.youtube.com/user/PATRICBRC">YouTube</a></li>
						<li><a class="footer-icons sprite-icon-share"
							href="//www.addthis.com/bookmark.php?v=250&amp;username=xa-4c40660c515875dc">Share
								This</a></li>
					</ul>
				</div>
			</div>
